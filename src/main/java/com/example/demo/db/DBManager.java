...
public class DBManager {
   ...
   public static Account emailCheckWithEmail(String email, String aid) {
      SqlSession session =  sqlSessionFactory.openSession();
      Account a = null;
      HashMap<String, String> params = new HashMap<>();
       params.put("email", email);
       params.put("aid", aid);
       System.out.println("DBManager id:"+aid);
   ...
   //class
	...
	public static void resetpwd(HashMap<String, Object> map) {
		SqlSession session =  sqlSessionFactory.openSession();
        int re = session.update("account.resetpwd", map);
        session.commit();
